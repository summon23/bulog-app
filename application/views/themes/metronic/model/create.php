                            ...
                            <?php switch ($value['type']) {
                                ...
                                case 'text': ?>
                                    <div class="form-group m-form__group">
                                        ...
                                        <input type="<?php echo $value['type'];?>" name="<?php echo $key;?>" class="form-control m-input" id="input-<?php echo $key;?>" placeholder="Type Here" <?php if($optional) : echo ''; else: echo 'required'; endif;?>>
